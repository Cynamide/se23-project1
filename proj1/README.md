...
Number of commits	3	"https://github.com/kingan1/application-tracking-system/graphs/contributors
341 is a good number if commits"	
...
Issues reports: there are many	3	34 issues is a good number	
Issues are being closed	2	10 issues were still open	
...
Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing	3	application-tracking-system/Software Documentation.pdf at main · kingan1/application-tracking-system (github.com)	
Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.	3	application-tracking-system/Demo Video.mp4 at main · kingan1/application-tracking-system (github.com)	
Use of version control tools	3	application-tracking-system/requirements.txt at main · kingan1/application-tracking-system (github.com)	
Use of style checkers	3	application-tracking-system/requirements.txt at main · kingan1/application-tracking-system (github.com)	
Use of code formatters.	3	application-tracking-system/requirements.txt at main · kingan1/application-tracking-system (github.com)	
Use of syntax checkers.	3	application-tracking-system/requirements.txt at main · kingan1/application-tracking-system (github.com)	
...
Is the name of your project/software unique?	Yes	"application-tracking-system/docs/Sustainability_Evaluation.pdf at main · kingan1/application-tracking-system (github.com)

The Software name is called J-tracker"	
...
Do you store your documentation under revision control with your source code?	Yes	application-tracking-system/Software Documentation.pdf at main · kingan1/application-tracking-system (github.com)	
Do you publish your release history e.g. release data, version numbers, key features of each release etc. on your web site or in your documentation?	Yes	Releases · kingan1/application-tracking-system (github.com)	
...
Does your project have a ticketing system to manage bug reports and feature requests?	Yes	application-tracking-system/Contributing.md at main · kingan1/application-tracking-system (github.com)	
...
Is your software’s architecture and design modular?	Yes	https://github.com/kingan1/application-tracking-system/blob/main/resources/Overall%20Design.PNG	
...
Does your website state how many projects and users are associated with your project?	Yes	"application-tracking-system/readme.md at main · kingan1/application-tracking-system (github.com)
https://github.com/kingan1/application-tracking-system/projects?type=classic"	Readme lists users associated with project and has two projects
...
Does your website and documentation clearly state the copyright owners of your software and documentation?	Yes	"https://github.com/kingan1/application-tracking-system/blob/main/readme.md
https://github.com/kingan1/application-tracking-system/blob/main/Software%20Documentation.pdf"	First link lists copyright owners is software and second link lists copyright owners in documentation
