...
### Link to Repo: https://github.com/Cynamide/application-tracking-system
|Criteria|Score|evidence|Notes|
| -----|-| -------| ----|
|Video	|||
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...|2|https://github.com/Cynamide/application-tracking-system/commits/main|
|but nevertheless, here is a track record that everyone is contributing a lot)|3|https://github.com/Cynamide/application-tracking-system/commits/main https://github.com/Cynamide/application-tracking-system/commits/dev https://github.com/Cynamide/application-tracking-system/commits/release|
|Number of commits|3|https://github.com/Cynamide/application-tracking-system/commits/main||
|Number of commits: by different people	|2|	https://github.com/Cynamide/application-tracking-system/commits/main https://github.com/Cynamide/application-tracking-system/commits/dev https://github.com/Cynamide/application-tracking-system/commits/release ||
|Issues reports: there are many	|2	|https://github.com/Cynamide/application-tracking-system/issues?q=is%3Aopen+is%3Aissue|
|Issues are being closed	|2	|https://github.com/Cynamide/application-tracking-system/issues?q=is%3Aissue+is%3Aclosed|	|
...
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.	|3	| https://github.com/Cynamide/application-tracking-system
|Use of version control tools	|2	|	|
|Use of style checkers	|2	|	https://github.com/Cynamide/application-tracking-system/actions/workflows/super-linter.yml
|Use of code formatters.	|	2|	https://github.com/Cynamide/application-tracking-system/actions/workflows/super-linter.yml|
|Use of syntax checkers.	|2	|	https://github.com/Cynamide/application-tracking-system/actions/workflows/super-linter.yml|
|Use of code coverage		|3	|application-tracking-system/requirements.txt at main · Cynamide/application-tracking-system (github.com)	|
|Other automated analysis tools	|3	|application-tracking-system/requirements.txt at main · Cynamide/application-tracking-system (github.com)	|
|Test cases exist	|1	|application-tracking-system/backend/test_app.py at build_fix · Cynamide/application-tracking-system (github.com)	|
|Test cases are routinely executed	|2	|application-tracking-system/.github/workflows/pytest_ci.yml at main · Cynamide/application-tracking-system	|
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up	|2	|application-tracking-system/Contributing.md at main · Cynamide/application-tracking-system (github.com)	|
|Issues are discussed before they are closed	|	|  | 	|
|Chat channel: exists	|3	|https://github.com/Cynamide/application-tracking-system/blob/main/docs/proj1rubric.md	
|Test cases: a large proportion of the issues related to handling failing cases.	|2	|application-tracking-system/backend/test_app.py at main · Cynamide/application-tracking-system (github.com)	|
|Evidence that the whole team is using the same tools: everyone can get to all tools and files	|3	|Comparing Team-Glare:main...Cynamide:main · Team-Glare/application-tracking-system (github.com)	|
|Evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)	|3	|Comparing Team-Glare:main...Cynamide:main · Team-Glare/application-tracking-system (github.com)	|
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)	|3	|Comparing Team-Glare:main...Cynamide:main · Team-Glare/application-tracking-system (github.com)	|
|Evidence that the members of the team are working across multiple places in the code base	|2	|Comparing Team-Glare:main...Cynamide:main · Team-Glare/application-tracking-system (github.com)	|
|Short release cycles	|3	|Releases · Cynamide/application-tracking-system (github.com)	|
|Does your website and documentation provide a clear, high-level overview of your software?	|Yes	|Cynamide/application-tracking-system: Application Tracking System for Group21, Project 3 (github.com)	|
|Does your website and documentation clearly describe the type of user who should use your software?	|Yes	|Cynamide/application-tracking-system: Application Tracking System for Group21, Project 3 (github.com)	|
...
|Is each source code release a snapshot of the repository?	|Yes	|Releases · Cynamide/application-tracking-system (github.com)	
...
|Is your contributions' policy publicly available?	|Yes	|application-tracking-system/Contributing.md at main · Cynamide/application-tracking-system (github.com)	
